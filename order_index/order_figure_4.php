...
<?php include_once("../inc/masthead.php"); ?>
	  ...
	  <br>
	  <h2>Your enquiry</h2>
	  <h3>Four figures information</h3>
  ...
  <div class="col-md-9">
	 ...
	 <div class="col-md-6">
	 <div class="form-group">
	  <label for="genderSelect4">Gender?</label>
	 <select class="form-control" id="genderSelect4" name="genderSelect4" required>
	<option>Male</option>
	<option>Female</option>
	</select>
	</div>
	...
	<div class="col-md-6">
	 <div class="form-group">
	  <label for="hairSelect4">Hair colour?</label>
	 <select class="form-control" id="hairSelect4" name="hairSelect4">
	<option>Black</option>
	<option>White</option>
	<option>Grey</option>
	<option>Yellow</option>
	...
	<div class="col-md-6">
	 <div class="form-group">
	  <label for="glassesSelect4">Glasses?</label>
	 <select class="form-control" id="glassesSelect4" name="glassesSelect4">
	<option>No</option>
	<option>Yes</option>
	</select>
	</div>
	...
	<div class="col-md-6">
	<div class="form-group">
    <label for="hairStyle4">Hair style</label>
    <input type="text" class="form-control" id="hairStyle4" name="hairStyle4" placeholder="Hair style">
  </div>
  </div>
  <div class="col-md-6">
	<div class="form-group">
    <label for="skinTone4">Skin tone</label>
    <input type="text" class="form-control" id="skinTone4" name="skinTone4" placeholder="Skin tone">
  </div>
  </div>
  <div class="col-md-6">
	<div class="form-group">
    <label for="outfit4">Outfit</label>
    <input type="text" class="form-control" id="outfit4" name="outfit4" placeholder="Outfit">
  </div>
  </div>
  <div class="col-md-6">
	<label for="otherDetails4">Other details?</label>
	<textarea class="form-control" id="otherDetails4" name="otherDetails4" placeholder="Other details"  rows="3"></textarea>
  </div>
  </div>
  <br>
