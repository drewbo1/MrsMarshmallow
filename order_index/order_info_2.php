...
<?php include_once("../inc/header.php"); ?>
    <title>Mrs Marshmallow | Cupcakes enquiry</title>
   ...
   <div class="container">
	 ...
	 <form action="cupcakes_info.php" method="post" id="infoForm" name="infoForm" onsubmit = "return Validate()">
	 <div class="row">
	 <div class="col-md-6">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="emailAddress"value="<?php echo $_SESSION['emailAddress']; ?>"  name="emailAddress" placeholder="Email address">
  </div>
  </div>
  <div class="col-md-6">
  <div class="form-group">
    <label for="confirmEmailAddress">Confirm email address *</label>
    <input type="email" class="form-control" id="confirmEmailAddress" value="<?php echo $_SESSION['confirmEmailAddress']; ?>" name="confirmEmailAddress" placeholder="Confirm email address">
  </div>
  </div>
  </div>
	<input class="btn btn-default btn-lg" name="submitButton" type="submit" value="Next">
