...
$cupcakeSelect = $_SESSION['cupcakeSelect'];
$cupcakeAmount = $_SESSION['cupcakeAmount'];
$cupcakeDetails1 = $_SESSION['cupcakeDetails1'];
$cupcakeDetails2 = $_SESSION['cupcakeDetails2'];
...
$email_message .= '<td>';
	...
	$email_message .= "<h2>Your details</h2><br>";
	...
	$email_message .= "<h2>Cupcake information</h2><br>";
    
    $email_message .= "How many cupcakes: ".clean_string($cupcakeSelect)."<br>"; 
 
    $email_message .= "Cupcake amount: ".clean_string($cupcakeAmount)."<br>";
 
    $email_message .= "Cupcake theme information: ".clean_string($cupcakeDetails1)."<br>";
 
    $email_message .= "Cupcake other information: ".clean_string($cupcakeDetails2)."<br>";
...
$mail->Username = "cupcakeenquiry@mrsmarshmallow.co.uk";  // SMTP username
$mail->Password = "wxe7nABgI0Wa"; // SMTP password

$mail->From = "cupcakeenquiry@mrsmarshmallow.co.uk";
$mail->FromName = "Cupcake enquiry";
