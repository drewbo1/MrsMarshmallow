...
<?php include_once("../inc/header.php"); ?>
   ...
   <div class="container">
     ...
     <?php include_once("../inc/masthead.php"); ?>
	  ...
	  <br>
	  <h2>Your enquiry</h2>
	  <h3>Three tier information</h3>
	  <br>
	  <h4>Bottom tier</h4>
	  
	  <form name="contactform" method="post" action="order_figure_select.php">
	 <div class="row">
	 <div class="col-md-6">
  ...
  <div class="col-md-6">
	...
	<div class="col-md-6">
	 <div class="form-group">
	  <label for="topDec3Select">Top decoration? *</label>
	 <select class="form-control" id="topDec3Select" name="topDec3Select" required>
	<option>No</option>
	<option>Yes</option>
	</select>
	</div>
