...
$email_message .= '<table border="1" cellpadding="0" cellspacing="0" width="100%">';

$email_message .= '<tr>';

$email_message .= '<td>';

$email_message .= '<table align="center" border="1" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">';
...
$email_message .= '<td valign="top" style="padding: 10 0 10 10;">';
...
$mail->Username = "balloonenquiry@mrsmarshmallow.co.uk";  // SMTP username
$mail->Password = "81BJTdVJh4TN"; // SMTP password

$mail->From = "balloonenquiry@mrsmarshmallow.co.uk";
