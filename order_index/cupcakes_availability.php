<?php include_once("../inc/header.php"); ?>
   ...
   <div class="container">
	  ...
	  <br>
	  <br>
	  <h2>Your cupcake enquiry</h2>
	  <br>
	  <h4>The calendar shown below details the availability for cupcakes over the next six months. If the date you require is not shown as being available then please don't make an enquiry as it can not be fulfilled.</h4>
	 <br>
	 <div class="row">
	  <div class="col-md-12">
  ...
  <input class="btn btn-default btn-lg" type="button" value="My date is available, please continue my enquiry" onClick="location.href='order_info_2.php'">
<br>
<br>
